...
<body id="page-top" class="home">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Keys to Learn</a>
            </div>
    ...
    <header id="landing-header">
        <div class="container prelude">
            <h1 class="fancy-title">Keys to Play</h1>
            </div>
        </div>
    </header>
    <hr></hr>
    ...
    <section id="contribute">
        ...
        <button class="btn btn-lg btn-primary">Contribute</button>
    </section>
    <hr></hr>

    <!-- Learn Grid Section -->
    <section id="learn" class="bg-light-gray">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="portfolio-item">
                        <a href="#">
                            <div class="row">
                                <div class="col-sm-5">
                                    <img src="http://www.singlondon.org/loudandproud/wp-content/uploads/2016/05/5-Street-Piano.jpg" class="img-responsive img-keys" alt="">
                                </div>
                                <div class="col-sm-7 cards">
                ...
                <div class="col-sm-6">
                    <div class="portfolio-item">
                        <a href="#">
                            <div class="row">
                                <div class="col-sm-5">
                                    <img src="https://fthmb.tqn.com/dttMwWlgNdiFijH1WoiGKruo-Tw=/1500x1000/filters:no_upscale():fill(FFCC00,1)/about/PlayingPianoChristmas-58b84c863df78c060e6942f5.jpg" class="img-responsive img-keys" alt="">
                                </div>
                                <div class="col-sm-7 cards">
                                    <h3>Practice</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur.</p>
